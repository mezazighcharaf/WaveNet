...
require_once __DIR__ . '/../models/EcoActionModel.php';

$model = new EcoActionModel();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add' || $action === 'update') {
        // Validation des champs obligatoires (sans points_verts maintenant)
        ...
        if (empty($errors)) {
            // Calcul automatique des points verts selon la catégorie
            $pointsVerts = $model->attribuerPointsParCategorie($_POST['categorie']);
