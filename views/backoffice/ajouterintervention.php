<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (!empty($_POST['id_signalement']) && !empty($_POST['statut'])) {
            ...
            if ($result !== false) {
                $_SESSION['success'] = "L'intervention a été ajoutée avec succès.";
                header('Location: interventions.php?added=true');
                exit;
            } else {
    ...
    <head>
        ...
        <title>Ajouter Intervention - Backoffice - WaveNet</title>
